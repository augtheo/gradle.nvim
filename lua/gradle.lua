...
--- Returns a list of all the tasks names of a project
--
-- @param cwd
--   The working directory of the project
--
-- @return
--   A list (sequence) of task names. Each value of a task is a string.
function M.getTasksAsList(cwd)
  local job = vim.g.gradle.job_id
  local taskList = {}
  local tasks = vim.fn.rpcrequest(job, "request", "get-tasks", cwd)
  for i, task in ipairs(tasks) do
    table.insert(taskList, task.name)
  end
  return taskList
end
